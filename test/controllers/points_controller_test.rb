...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference("Point.count") do
      post points_url, params: { point: { coins: @point.coins, logo: @point.logo, name: @point.name } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { coins: @point.coins, logo: @point.logo, name: @point.name } }
